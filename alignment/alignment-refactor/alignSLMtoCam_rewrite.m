...
% this is all used later, can probably ignore fro now?
sz = size(bgd);
gridpts = 25;
...
% below seems to not be used at all?
%{
...
ao = AlignOptotune(SISocket, masterSocket, sutter, bas);
SIdepthImages = ao.optoSearch();
ao.doFits(SIdepthImages);
