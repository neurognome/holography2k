...
%
% The separate ThorCam addpath goes as well: this file lives in cameras/ThorCam of
% this repo, which makePaths genpath's, so the camera code is already on the path.
% It was pointing at a copy under that retired tree.
makePaths();
